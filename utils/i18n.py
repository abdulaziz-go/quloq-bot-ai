...
STRINGS = {
    "en": {
        ...
        "err_too_long_tts": "❌ *Text too long\\!*\\n\\nMaximum allowed length for TTS is *5,000 characters*\\.",
        "buy_menu_tts": "🎙 *Text\\-to\\-Speech Plans*\\n\\n• 20 TTS requests — $1\\.00\\n• 100 TTS requests — $4\\.00\\n• 300 TTS requests — $10\\.00",
    ...
    "ru": {
        ...
        "err_too_long_tts": "❌ *Текст слишком длинный\\!*\\n\\nМаксимальная длина текста для TTS — *5,000 символов*\\.",
